                ...
                msg = await message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `${data.ban ? '<:icon_cross:1345041135156072541> ' : '<:tick_icons:1345041197483298856> '}: **Ban**\n${data.kick ? '<:icon_cross:1345041135156072541> ' : '<:tick_icons:1345041197483298856> '}: **Kick**\n${data.prune ? '<:icon_cross:1345041135156072541> ' : '<:tick_icons:1345041197483298856>'}: **Prune**\n${data.botadd ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Bot Add**\n${data.serverup ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Server Update\n${data.memup ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: Member Role Update**\n${data.chcr ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Channel Create**\n${data.chdl ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: ** Channel Delete**\n${data.chup ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Channel Update**\n${data.rlcr ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Role Create**\n${data.rldl ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Role Delete**\n${data.rlup ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Role Update**\n${data.meneve ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Mention** @everyone\n${data.mngweb ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Webhook Management**\n${data.mngstemo ? '<:icon_cross:1345041135156072541>' : '<:tick_icons:1345041197483298856>'}: **Emojis & Stickers Management**`                      )
                            .addFields(
                                {
                                    name: `**Executor**`,
                                    value: `<@!${message.author.id}>`,
