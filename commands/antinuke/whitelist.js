            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription(
                            `<:icon_cross:1345041135156072541> | Your Server Doesn't Meet 5 Member Criteria`
                        )
                ]
            })
        }
                ...
                msg = await message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `<:icon_cross:1345041135156072541> : **Ban**\n<:icon_cross:1345041135156072541> : **Kick**\n<:icon_cross:1345041135156072541> : **Prune**\n<:icon_cross:1345041135156072541> : **Bot Add**\n<:icon_cross:1345041135156072541> : **Server Update\n<:icon_cross:1345041135156072541> : Member Role Update**\n<:icon_cross:1345041135156072541> : **Channel Create**\n<:icon_cross:1345041135156072541> :** Channel Delete**\n<:icon_cross:1345041135156072541> : **Channel Update**\n<:icon_cross:1345041135156072541> : **Role Create**\n<:icon_cross:1345041135156072541> : **Role Delete**\n<:icon_cross:1345041135156072541> : **Role Update**\n<:icon_cross:1345041135156072541> : **Mention** @everyone\n<:icon_cross:1345041135156072541> : **Webhook Management**\n<:icon_cross:1345041135156072541> : **Emojis & Stickers Management**`
                            )
                            .addFields(
                                {
                                    name: `**Executor**`,
                ...
                msg = await message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `${data.ban ? '<:tick_icons:1345041197483298856> ' : '<:icon_cross:1345041135156072541>'}: Ban\n${data.kick ? '<:tick_icons:1345041197483298856> ' : '<:icon_cross:1345041135156072541> '}: Kick\n${data.prune ? '<:tick_icons:1345041197483298856> ' : '<:icon_cross:1345041135156072541>'}: Prune\n${data.botadd ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Bot Add\n${data.serverup ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Server Update\n${data.memup ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Member Role Update\n${data.chcr ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Channel Create\n${data.chdl ? '<:tick_icons:1345041197483298856> ' : '<:icon_cross:1345041135156072541>'}:  Channel Delete\n${data.chup ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Channel Update\n${data.rlcr ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Role Create\n${data.rldl ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Role Delete\n${data.rlup ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Role Update\n${data.meneve ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Mention @everyone\n${data.mngweb ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Webhook Management\n${data.mngstemo ? '<:tick_icons:1345041197483298856>' : '<:icon_cross:1345041135156072541>'}: Emojis & Stickers Management`                 ) 
                                .addFields(
                                {
                                    name: `**Executor**`,
                                    value: `<@!${message.author.id}>`,
